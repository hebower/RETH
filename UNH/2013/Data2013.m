...
% GCR
data_GCR = load('UNH2013GCR.txt'); %Bring in the 2013 CRaTER Data
...
aa = title('2013','position',[0.2050 206.0440 -1.4211e-14]);
...
data_SPE = load('UNH2013SPE.txt'); %Bring in the 2013 CRaTER Data
...
data_comb = load('UNH2013Comb.txt'); %Bring in the 2013 CRaTER Data
...
print(1,'All_rad_2013', '-dpng', '-r900')
print(2,'Proba_rad_2013', '-dpng', '-r900')
