...
% GCR
data_GCR = load('UNH2011GCR.txt'); %Bring in the 2011 CRaTER Data
...
aa = title('2011','position',[0.2050 206.0440 -1.4211e-14]);
...
data_SPE = load('UNH2011SPE.txt'); %Bring in the 2011 CRaTER Data
...
data_comb = load('UNH2011Comb.txt'); %Bring in the 2011 CRaTER Data
...
print(1,'All_rad_2011', '-dpng', '-r900')
print(2,'Proba_rad_2011', '-dpng', '-r900')
