...
% GCR
data_GCR = load('UNH2014GCR.txt'); %Bring in the 2014 CRaTER Data
...
aa = title('2014','position',[0.2050 206.0440 -1.4211e-14]);
...
data_SPE = load('UNH2014SPE.txt'); %Bring in the 2014 CRaTER Data
...
data_comb = load('UNH2014Comb.txt'); %Bring in the 2014 CRaTER Data
...
print(1,'All_rad_2014', '-dpng', '-r900')
print(2,'Proba_rad_2014', '-dpng', '-r900')
