...
% GCR
data_GCR = load('UNH2010GCR.txt'); %Bring in the 2010 CRaTER Data
...
aa = title('2010','position',[0.2050 206.0440 -1.4211e-14]);
...
legend('Exper. data (GCR)','Normal distr.','location','northwest')

%==================================================
% SPE
clear DOY D1_2 mat  m_d st_d
data_SPE = load('UNH2010SPE.txt'); %Bring in the 2010 CRaTER Data
...
legend('Exper. data (SPE)','Normal distr.','location','northwest')

%==================================================
% COMB
clear DOY D1_2 y xx mat m_d st_d

data_comb = load('UNH2010Comb.txt'); %Bring in the 2010 CRaTER Data
DOY = data_comb(:,3); %Day of Year
D1_2 = data_comb(:,8); %Detectors 1&2 dose rates
...
ylabel('CDF','fontweight','bold','fontsize',12)
xlabel('Average Dose/day','fontweight','bold','fontsize',12)
 aaa = legend('Exper. data (Comb)','Normal distr.','location','northwest');

legend([f1 f2 f3],'GCR','SPE','Comb')
...
print(1,'All_rad_2010', '-dpng', '-r900')
print(2,'Proba_rad_2010', '-dpng', '-r900')
