...
legend('Exper. data (SPE2012)','Normal distr.','location','northwest')

%==================================================
% SPE 2013
clear DOY D1_2 mat  m_d st_d
data_SPE2013 = load('UNH2013SPE.txt'); %Bring in the 2013 CRaTER Data
DOY = data_SPE2013(:,3); %Day of Year
D1_2 = data_SPE2013(:,8); %Detectors 1&2 dose rates
...
legend('Exper. data (SPE2013)','Normal distr.','location','northwest')

%==================================================
% SPE2014
clear DOY D1_2 y xx mat m_d st_d

data_SPE2014 = load('UNH2014SPE.txt'); %Bring in the 2014 CRaTER Data
DOY = data_SPE2014(:,3); %Day of Year
D1_2 = data_SPE2014(:,8); %Detectors 1&2 dose rates
...
ylabel('CDF','fontweight','bold','fontsize',12)
xlabel('Average Dose/day','fontweight','bold','fontsize',12)
 aaa = legend('Exper. data (SPE2014)','Normal distr.','location','northwest');

legend([f1 f2 f3],'2012','2013','2014')
...
print(1,'All_SPEMax', '-dpng', '-r900')
print(2,'Proba_SPEMax', '-dpng', '-r900')
